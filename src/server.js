...
// These origin values don't actually have to be anything - this project exists without a front-end, but any front-end
// that should interact with this API should be listed in the array of origins for CORS configuration.
...
// Add a route to ensure the app works. This path is the server API's "homepage"
...
// Keep this file at the end of this file, before exports. 
// A 404 route should only trigger if no preceeding routes or middleware has run.
app.get("/", (request, response) => {
